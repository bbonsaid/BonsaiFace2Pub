package com.example.bonsaiface2
...
class MyWatchFace : CanvasWatchFaceService() {
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        private lateinit var mMatsubaLBitmap: Bitmap
        private lateinit var mMatsubaSBitmap: Bitmap
        private lateinit var mBranchLBitmap: Bitmap
        private lateinit var mBranchSBitmap: Bitmap
        private lateinit var mMatsubaBitmap: Bitmap
        ...
        private fun initializeWatchFace() {
            ...
            mMatsubaLBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.matsuba_l)
            mMatsubaSBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.matsuba_s)
            mBranchLBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.branch_l)
            mBranchSBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.branch_s)
            mMatsubaBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.matsuba)
        ...
        private fun drawWatchFace(canvas: Canvas) {
            ...
            val hMatrix = Matrix()
            hMatrix.setTranslate(mCenterX - 60f, mCenterY - 100f)
            hMatrix.postRotate(hoursRotation.toFloat(), mCenterX, mCenterY)
            ...
            canvas.drawBitmap(
                mMatsubaSBitmap,
                (mXe - (mMatsubaSBitmap.width / 2)).toFloat(),
                (mYe - mMatsubaSBitmap.height).toFloat() + 25f,
                mBackgroundPaint
            )
            ...
            if (!mAmbient) {
                val sMatrix = Matrix()
                sMatrix.setTranslate(mCenterX - mMatsubaBitmap.width / 2, mCenterY - 220f)
                sMatrix.postRotate(secondsRotation.toFloat(), mCenterX, mCenterY)
                canvas.drawBitmap(mMatsubaBitmap, sMatrix, mBackgroundPaint)
            }
        }
